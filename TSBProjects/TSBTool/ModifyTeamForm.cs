...
namespace TSBTool
{
	...
	public class ModifyTeamForm : System.Windows.Forms.Form
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(ModifyTeamForm));
			...
			this.m_SimDefenseUpDown.Maximum = new System.Decimal(new int[] {
																			   15,
																			   0,
																			   0,
																			   0});
			...
			this.m_SimOffenseUpDown.Maximum = new System.Decimal(new int[] {
																			   15,
																			   0,
																			   0,
																			   0});
			...
			this.m_Run4UpDown.Maximum = new System.Decimal(new int[] {
																		 8,
																		 0,
																		 0,
																		 0});
			this.m_Run4UpDown.Minimum = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			...
			this.m_Run4UpDown.Value = new System.Decimal(new int[] {
																	   1,
																	   0,
																	   0,
																	   0});
			...
			this.m_Run3UpDown.Maximum = new System.Decimal(new int[] {
																		 8,
																		 0,
																		 0,
																		 0});
			this.m_Run3UpDown.Minimum = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			...
			this.m_Run3UpDown.Value = new System.Decimal(new int[] {
																	   1,
																	   0,
																	   0,
																	   0});
			...
			this.m_Run2UpDown.Maximum = new System.Decimal(new int[] {
																		 8,
																		 0,
																		 0,
																		 0});
			this.m_Run2UpDown.Minimum = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			...
			this.m_Run2UpDown.Value = new System.Decimal(new int[] {
																	   1,
																	   0,
																	   0,
																	   0});
			...
			this.m_Run1UpDown.Maximum = new System.Decimal(new int[] {
																		 8,
																		 0,
																		 0,
																		 0});
			this.m_Run1UpDown.Minimum = new System.Decimal(new int[] {
																		 1,
																		 0,
																		 0,
																		 0});
			...
			this.m_Run1UpDown.Value = new System.Decimal(new int[] {
																	   1,
																	   0,
																	   0,
																	   0});
			...
			this.m_Pass4UpDown.Maximum = new System.Decimal(new int[] {
																		  8,
																		  0,
																		  0,
																		  0});
			this.m_Pass4UpDown.Minimum = new System.Decimal(new int[] {
																		  1,
																		  0,
																		  0,
																		  0});
			...
			this.m_Pass4UpDown.Value = new System.Decimal(new int[] {
																		1,
																		0,
																		0,
																		0});
			...
			this.m_Pass3UpDown.Maximum = new System.Decimal(new int[] {
																		  8,
																		  0,
																		  0,
																		  0});
			this.m_Pass3UpDown.Minimum = new System.Decimal(new int[] {
																		  1,
																		  0,
																		  0,
																		  0});
			...
			this.m_Pass3UpDown.Value = new System.Decimal(new int[] {
																		1,
																		0,
																		0,
																		0});
			...
			this.m_Pass2UpDown.Maximum = new System.Decimal(new int[] {
																		  8,
																		  0,
																		  0,
																		  0});
			this.m_Pass2UpDown.Minimum = new System.Decimal(new int[] {
																		  1,
																		  0,
																		  0,
																		  0});
			...
			this.m_Pass2UpDown.Value = new System.Decimal(new int[] {
																		1,
																		0,
																		0,
																		0});
			...
			this.m_Pass1UpDown.Maximum = new System.Decimal(new int[] {
																		  8,
																		  0,
																		  0,
																		  0});
			this.m_Pass1UpDown.Minimum = new System.Decimal(new int[] {
																		  1,
																		  0,
																		  0,
																		  0});
			...
			this.m_Pass1UpDown.Value = new System.Decimal(new int[] {
																		1,
																		0,
																		0,
																		0});
