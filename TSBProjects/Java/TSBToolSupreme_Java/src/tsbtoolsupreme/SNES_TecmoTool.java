...
/// <summary>
    ...
    public class SNES_TecmoTool implements ITecmoTool
    {
        ...
        /// </summary>
        public String getRomVersion() {  return "SNES";  }
...
"    If you know this is really a snes TSB1 ROM, you can force TSBToolSupreme to load it in GUI mode.";
        ...
        private  byte[] m_JuiceArray = 
       {
        ...
        private byte GetWhiteMask(int positionIndex)
        {
            ...
            switch(bitIndex)
            {
                case 0: ret = (byte)0x7F; break;//01111111
                case 1: ret = (byte)0xBF; break;//10111111
                case 2: ret = (byte)0xDF; break;//11011111
                case 3: ret = (byte)0xEF; break;//11101111
                case 4: ret = (byte)0xF7; break;//11110111
                case 5: ret = (byte)0xFB; break;//11111011
                case 6: ret = (byte)0xFD; break;//11111101
                case 7: ret = (byte)0xFE; break;//11111110
            }
            return ret;
        }
        private byte GetColorMask(int positionIndex)
        {
            ...
            switch(bitIndex)
            {
                case 0: ret = (byte)0x80; break;//10000000
                case 1: ret = (byte)0x40; break;//01000000
                case 2: ret = (byte)0x20; break;//00100000
                case 3: ret = (byte)0x10; break;//00010000
                case 4: ret = (byte)0x08; break;//00001000
                case 5: ret = (byte)0x04; break;//00000100
                case 6: ret = (byte)0x02; break;//00000010
                case 7: ret = (byte)0x01; break;//00000001
            }
            return ret;
        }
